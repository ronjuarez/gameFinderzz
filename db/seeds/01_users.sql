INSERT INTO users (
    ...
    -- title, description, owner_id, cover_photo_url, thumbnail_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, is_active, province, city, country, street, post_code)
    -- VALUES (
    -- 'List least', 'Younger week student surface speak how sick bark outside combine wide thou improve recent plane soon behavior teacher tape adult pencil remain bear laugh free spin make stick victory picture wheat successful near correctly swept steep lake chapter card film telephone identity brick lucky electricity solar captain rest surprise worth folks caught example larger headed sugar symbol represent handle dot spell straw barn plate among party long fix fifteen had show chain way religious rest afternoon bat accurate behavior bigger term exact hang without him garden yet fur spirit cut bright money plus eight birthday composition soil she minute industrial silk hair herd chief silence temperature thought teacher show signal eye grew deal conversation tank castle energy empty cast carbon care western climate zipper cloth moving lovely shot brush angry ready popular zebra definition grabbed matter leaf picture pipe make paid away refused year service proud balance water fish road massage highway instance yes some doctor board happily here fog plates upon finger secret form fifty sets forth winter bone flag age bottle native whatever should bat farther far local frighten green scientist shoe old finally managed article become equator funny forgot coach happy manner range village baseball tired nuts cat slowly possibly motor develop move found crowd blue aware action may two changing pitch final stick sides sea rear hunt pet handle simple by ought rest machine who spread setting standard too street smallest us extra wear terrible dust ourselves animal underline him unusual contain happily red nearer storm bag ship trouble skin outline pattern among avoid wolf suit brain too doll pig atmosphere warm future society planned nearer lift me storm capital building applied effect cotton share clay report heat around nose sum aware as pot question spend respect equal hill slide independent fully children shorter fed energy', 391, 'https://images.pexels.com/photos/2099019/pexels-photo-2099019.jpeg', 'https://images.pexels.com/photos/2099019/pexels-photo-2099019.jpeg?auto=compress&cs=tinysrgb&h=350', 34565, 0, 1, 1, true, 'Newfoundland And Labrador', 'Paradise', 'Canada', '1848 Cuzo Trail', '08409');
    -- INSERT INTO properties (
    -- title, description, owner_id, cover_photo_url, thumbnail_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, is_active, province, city, country, street, post_code)
    -- VALUES (
    -- 'Done game', 'Invented friendly longer circle agree today yet family trunk yard door noted chemical struck queen grandmother shelf at state command zulu from proper spoken powerful closely throat ability field went beside thought seat rock offer partly fair smooth announced even news carried habit film shells complex outer driven track are flag wise eager explain feature boy is_active proud thank writing due native last reason camera settle piece melted won draw was bark foreign given catch law minerals climb break mail force dawn pie rule simplest offer chance jump gold correctly lucky hit chemical new island start like gas loud create general group simple difficulty action back bean spend for telephone gentle there page tape position chapter oil tea fact sugar jungle receive ride poor join today soap belt jungle many wonderful difficulty swung cannot sale wear apartment gulf remove fresh somebody art hole third wash exercise jet development for giving health front knife underline source catch meat recent fifty band apartment father human bank shaking film education oxygen return greatly compass lion careful girl zebra building some function citizen eight noted die coming frequently dug day consonant phrase youth black exciting evidence influence floating blind behavior system vowel first telephone pretty thank shoulder north affect tail country track corn against middle valley found wing buried village station claws each fat birds ordinary coming felt square circle instance gold felt price themselves inside send smaller nation speed meet flew find flat tightly whenever rubber sick raise store left sunlight step appropriate cheese kill public come rhythm handsome couple bend ready locate take skill horn circle climb distant edge carried against one title among plates grade list burn enough refer sand government shadow mixture buy valuable frighten either parts early tone mill him tell moon never action yes respect believed seen whale', 69, 'https://images.pexels.com/photos/271649/pexels-photo-271649.jpeg', 'https://images.pexels.com/photos/271649/pexels-photo-271649.jpeg?auto=compress&cs=tinysrgb&h=350', 57597, 0, 1, 7, true, 'Prince Edward Island', 'Summerside', 'Canada', '1624 Cufpip Square', '79224');
    -- INSERT INTO properties (
    -- title, description, owner_id, cover_photo_url, thumbnail_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, is_active, province, city, country, street, post_code)
    -- VALUES (
